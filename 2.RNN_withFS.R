...
### FSOSVM-FS
# RankedFeatureList <- c("dttl", "dtcpb", "sttl", "smean", "stcpb", "ct_state_ttl", "sjit", "sbytes", "dload", "ct_srv_dst", "sload", "proto_igmp", "ct_srv_src", "dloss", "ct_flw_http_mthd", "dbytes", "dmean", "service_dns", "rate", "ct_dst_sport_ltm", "dwin", "proto_arp", "dinpkt", "ct_dst_ltm", "spkts", "service_-", "ackdat", "service_smtp", "service_ftp" ,"proto_icmp", "djit", "response_body_len")

### C5.0-FS
# RankedFeatureList <- c("sttl", "service_dns", "ct_state_ttl", "ct_src_dport_ltm", "ct_srv_dst", "sbytes", "dbytes", "smean", "proto_sun-nd", "proto_swipe", "proto_mobile", "ct_srv_src", "ct_dst_src_ltm", "dpkts", "proto_udp", "ct_dst_sport_ltm", "dinpkt", "ct_dst_ltm", "ct_flw_http_mthd", "is_ftp_login", "dmean", "ct_src_ltm", "trans_depth", "sloss", "dload", "spkts", "dloss", "service_http", "synack", "response_body_len", "sload", "sinpkt", "dur", "service_-", "rate", "ackdat", "sjit", "proto_igmp", "proto_tcp")

### CART-FS
RankedFeatureList <- c("sttl", "ct_state_ttl", "dload", "dmean", "dbytes", "dpkts", "sbytes", "ct_srv_dst", "ct_dst_src_ltm", "ct_srv_src", "spkts", "sinpkt", "dur", "smean", "rate", "sjit", "ct_src_dport_ltm", "sloss", "ct_dst_ltm", "proto_tcp", "swin", "sload", "ct_dst_sport_ltm", "dinpkt", "djit", "proto_udp", "response_body_len", "service_http", "dloss", "tcprtt", "service_-", "synack", "ct_src_ltm", "proto_arp", "ackdat", "is_sm_ips_ports", "ct_flw_http_mthd", "trans_depth", "dtcpb", "proto_mobile", "proto_sun-nd", "proto_swipe", "dttl", "service_dns", "proto_icmp", "stcpb", "proto_mux", "service_ftp")
# ----------------------------------------------------------------------------------------------------------------------------------- #
...
TrainingDatasetX <- TrainingDatasetX[,RankedFeatureList]
TestDatasetX <- TestDatasetX[,RankedFeatureList]
...
train_seq <- create_sequences(TrainingDatasetXT, TrainingDatasetYT, timesteps = 10)
test_seq  <- create_sequences(TestDatasetXT,  TestDatasetYT,  timesteps = 10)
# ------------------------------------------------- #
